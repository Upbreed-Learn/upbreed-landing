        ...
        <div className="flex w-full justify-center bg-[#F2F2F2]">
          <section className="w-full max-w-7xl px-9 py-10 md:px-18 md:py-20">
            <p className="">
              ...
              mentors, and industry experts, enhancing their educational
              journey. We offer access to top African instructors who bring
              real-world expertise, ensuring that the content is both relevant
              and inspiring. <br /> <br />
              ...
              education through technology, empowering individuals to reach
