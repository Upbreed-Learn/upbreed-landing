const Privacy = () => {
  return (
    <div>
      ...
      <p className="text-sm leading-[30px] font-semibold">
        ...
        of Lorem Ipsum. <br /> Why do we use it? <br /> It is a long established
        ...
        humour and the like). <br /> <br /> Where does it come from? <br />{' '}
